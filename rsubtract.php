...
if (isset($_POST['submit'])) {
    ...
    if ($count > 0) {
        // Comment out or remove the line below to prevent displaying the message
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            $updateSql = "UPDATE stock t2
                          INNER JOIN rworder t1 ON t1.icode = t2.icode
                          SET t2.cstock = CASE
            ...
            if ($conn->query($updateSql) === TRUE) {
                ...
                header("Location: rdisplay.php?erp=$erp");
                exit;
            } else {
...
<body>
    <div class="container">
        ...
        <form method="POST" action="rsubtract.php">
            <label for="erp"></label>
