...
<div class="container">
    ...
    if ($result->num_rows > 0) {
        echo "<table>";
        echo "<tr><th>Date</th><th>Plan Tires Nos</th><th>Stock Order Tires Nos</th><th>Work Order Tires Nos</th><th>Utilized/Plan Cavity Nos</th><th>Total Cavity</th><th>Average Utilization (%)</th><th>Total Green Tire Weight</th></tr>";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td>{$totalPlanTires}</td>";
            echo "<td>{$totalStockOrderTires}</td>"; // Display the sum for erp = 960

            echo "<td>{$workOrderTiresNos}</td>"; // Subtract and display Work Order Tires Nos
