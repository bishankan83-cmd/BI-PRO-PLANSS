...
<body>
  <div class="container">
    <form method="post" action="">
      <input type="submit" name="button1" value="System Auto" class="gradient-button">
    </form>
    <form method="post" action="">
      <input type="submit" name="button2" value="Manual Trigger" class="gradient-button">
    </form>
    ...
    if (isset($_POST['button1'])) {
       ...
       // header("Location: plannew34new23.php");
        //exit();
          ...
          header("Location: import22bnew.php");
        exit();
    }
}
