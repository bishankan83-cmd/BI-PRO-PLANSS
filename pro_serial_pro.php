...
// Query to get data from production_serial table, sorted by production_date in descending order
$sql = "SELECT id, serial_number, formatted_serial, icode, created_at, updated_at, production_date 
        FROM production_serial 
...
<head>
    ...
    <title>Production Serial Data</title>
...
<body>
    <div class="container">
        ...
        <table class="stockr-table" id="productionTable">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Serial Number</th>
    ...
    <script>
        ...
        function exportToCSV() {
            ...
            link.download = 'production_serial_data.csv';
            link.click();
        }
    </script>
</body>
