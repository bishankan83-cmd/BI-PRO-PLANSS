...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            // If form is submitted, insert data into the barcodeb table
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                $quality_approved = $_POST["quality_approved"];
                $expire_date = $_POST["expire_date"];
                $staff_name = $_POST["staff_name"];

                $sql = "INSERT INTO barcodeb (quality_approved, expire_date, staff_name) VALUES ('$quality_approved', '$expire_date', '$staff_name')";
            ...
            // Fetch and display data from the barcodeb table
            $sql = "SELECT quality_approved, expire_date, staff_name FROM barcodeb";
...
document.getElementById("redirectButton").onclick = function() {
    ...
    window.location.href = "barcode_enter2b.php";
};
</script>
