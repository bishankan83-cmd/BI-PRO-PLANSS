...
$sql = "DELETE FROM another_table_name3b";
...
// SQL query to delete all data from the table
$sql = "DELETE FROM another_table_nameb";
...
$params = array();
    ...
    if ($result->num_rows > 0) {
        ...
        $sql_insert = "INSERT INTO another_table_name3b (inputDate, shift, compound_name, description, cstock, batch, pallet, created_at, weight, serial_number) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
