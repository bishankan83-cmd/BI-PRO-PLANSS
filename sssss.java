...
public class HotelManagementSystem {
    ...
    private void showLoginScreen() {
        ...
        btnLogin.setBackground(new Color(70, 130, 180));  // Steel blue background
        ...
        // Set the icon for the login screen
        ImageIcon loginIcon = new ImageIcon("login_icon.png");  // Path to the icon image
