...
try {
    ...
    if ($rowCount > 0) {
        ...
        // Step 3: If no data in process_plan, copy data from process_plan_tem to process_plan
        $copySql = "
            INSERT INTO process_plan (icode, mold_id, tires_per_mold, cavity_id, mold_name, cavity_name, press_name, press_id, erp, serial, is_completed, is_highlighted, first_tobe, start_date)
            SELECT icode, mold_id, tires_per_mold, cavity_id, mold_name, cavity_name, press_name, press_id, erp, serial, is_completed, is_highlighted, first_tobe, start_date
            FROM process_plan_tem
        ";
        
        // Execute the copy query
        $pdo->exec($copySql);
        echo "No data found in process_plan. Existing data from process_plan_tem has been copied to process_plan.";
    }
