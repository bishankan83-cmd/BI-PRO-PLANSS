    ...
    <table>
        ...
        <tbody>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $sql = "INSERT INTO barcoder (quality_approved, expire_date, staff_name) VALUES ('$quality_approved', '$expire_date', '$staff_name')";
            ...
            $sql = "SELECT quality_approved, expire_date, staff_name FROM barcoder";
...
document.getElementById("redirectButton").onclick = function() {
    ...
    window.location.href = "barcode_enter2r.php";
};
</script>
