...
<head>
    ...
    <title>Insert Loan outward Supplier Information</title>
...
<body>
            ...
            <div class="col-md-8 col-lg-6">
                <div class="supplier-container">
                    <div class="supplier-header">
                        <h2 class="mb-0">Insert Loan outward Supplier Information</h2>
                    </div>
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        // Sanitize inputs
                        $suppliers_code = htmlspecialchars(trim($_POST['suppliers_code']));
                        $suppliers_name = htmlspecialchars(trim($_POST['suppliers_name']));
                        $description = htmlspecialchars(trim($_POST['description']));
                        $production_category = htmlspecialchars(trim($_POST['production_category']));
                        ...
                        if (empty($errors)) {
                            ...
                            $stmt = $conn->prepare("INSERT INTO loan_outward_suppliers (suppliers_code, suppliers_name, description, production_category, contact_person, contact_no, address) VALUES (?, ?, ?, ?, ?, ?, ?)");
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            // Supplier code validation (alphanumeric)
