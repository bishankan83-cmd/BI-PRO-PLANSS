    ...
    try {
        ...
        if ($row = $result->fetch_assoc()) {
            ...
            if ($updated_number_of_bands == $previous_number_of_bands) {
              ...
              $insert_sql = "INSERT INTO loan_outward_details_settle  
            ...
            if ($delete_record) {
                ...
                $delete_sql = "DELETE FROM loan_outward_details2 WHERE loan_number = ?";
                ...
                $update_sql = "UPDATE loan_outward_details2 
            ...
            header("Location: view_inserted_data6.php?loan_number=" . urlencode($selected_po_number));
            exit();
                    ...
                    <div class="row">
                        <div class="col-md-8 mb-3">
                            ...
                            <select id="po_number" name="po_number" class="form-select" required>
                                ...
                                <?php
                                $result = $conn->query("SELECT loan_number FROM loan_outward_details2 ORDER BY loan_number");
