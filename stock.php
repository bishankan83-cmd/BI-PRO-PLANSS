...
<body>
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            <div class="card animate-on-scroll"s>
                ...
                <div class="card-body">
                    ...
                    <p><strong>Total Order Requirement:</strong> <span class="stat-value"><?= number_format(calculateTotalStockRequirement()); ?></span></p>
                    <p><strong>Total Stock Requirement:</strong> <span class="stat-value"><?= number_format(calculateTotalRequirement()); ?></span></p>
                </div>
            </div>
            ...
            <div class="card animate-on-scroll">
                ...
                <div class="card-body">
                    ...
                    <p><strong>Total Order Requirement Weight:</strong> <span class="stat-value"><?= number_format(floor(calculateTotalStockRequirementWeight(calculateTotalStockRequirement()))); ?></span></p>
                    <p><strong>Total Stock Requirement Weight:</strong> <span class="stat-value"><?= number_format(floor(calculateTotalRequirementWeight())); ?></span></p>
                </div>
            </div>
    ...
    <script>
        ...
        function updateTotalsDisplay() {
            ...
            document.getElementById('totalStockRequirement').innerHTML = 
                'Total Order Requirement: <span class="stat-value">' + totalStockRequirement.toLocaleString() + '</span>';
        }
