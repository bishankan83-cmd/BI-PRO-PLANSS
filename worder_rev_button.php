...
<body>
  <div class="container">
    <form method="post" action="">
      <input type="submit" name="button1" value="Edit Order" class="gradient-button">
    </form>
    <form method="post" action="">
      <input type="submit" name="button2" value="Upload Full Order" class="gradient-button">
    </form>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['button1'])) {
        ...
        header("Location: worder_result1.php");
        exit();
    } elseif (isset($_POST['button2'])) {
        // Redirect to the desired page when Button 2 is clicked
       // header("Location: plannew34new23.php");
        //exit();

          header("Location: rwork_delete.php");
        exit();
    }
}
