        ...
        <div class="row">
            <div class="col-12">
                <div class="table-container">
                    ...
                    $sql = "SELECT loan_number, loan_date, expected_delivery_date, suppliers_code, suppliers_name, rm_code, descriptions, number_of_bands FROM loan_inward_details_settle";
