...
echo "<td>Free Stock Compound Weight</td>";
echo "<td>Free Stock Compound ST Weight</td>";
echo "</tr>";
...
if (!$query_run) {
    echo "<tr><td colspan='10'>Error in stock query: " . mysqli_error($con) . "</td></tr>";
} else {
...
echo "<td colspan='10'>Summary calculations can be added here if needed</td>";
echo "</tr>";
