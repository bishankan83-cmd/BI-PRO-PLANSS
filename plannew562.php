...
ini_set('display_errors', 1);// Establish database connection
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $sql = "INSERT INTO plannew (id, icode, mold_id, cavity_id, start_date, end_date, erp, tires_per_mold, Customer)
