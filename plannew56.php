...
// SQL query to insert data from `process_plan` to `new_process` where `first_tobe` is 1
$sql = "
...
$deletetobe1 = "DELETE FROM tobeplan_tem";
mysqli_query($connection, $deletetobe);
...
$deletetobe1 = "DELETE FROM process_plan_tem";
mysqli_query($connection, $deletetobe);
