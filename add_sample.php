...
<div class="container">
    ...
    <form id="data-form" action="adinsert.php" method="post">
        ...
        <table id="data-table">
            ...
            <td><input type="text" name="reject[]" value=""></td>
                </tr>
            </tbody>
        </table>
...
function addRow() {
    ...
    const rejectInput = document.createElement("input");
            ...
            rejectInput.value = "TEST"; // Set default value for the Reject column
            cell4.appendChild(rejectInput); // Add Reject input to the new row
        }
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            if (existingRejectInput) {
                existingRejectInput.value = "TEST";
            }
        });
    </script>
</body>
