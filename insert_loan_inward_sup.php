...
<head>
    ...
    <title>Insert Loan Inward Supplier Information</title>
            ...
            <div class="col-md-8 col-lg-6">
                <div class="supplier-container">
                    <div class="supplier-header">
                        <h2 class="mb-0">Insert Loan Inward Supplier Information</h2>
                    </div>
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        if (empty($errors)) {
                            ...
                            $stmt = $conn->prepare("INSERT INTO loan_inward_suppliers (suppliers_code, suppliers_name, description, production_category, contact_person, contact_no, address) VALUES (?, ?, ?, ?, ?, ?, ?)");
