...
try {
    ...
    $sql = "SELECT suppliers_code, suppliers_name FROM loan_inward_suppliers";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql_insert = "INSERT INTO loan_inward_details (loan_date, expected_delivery_date, suppliers_code, suppliers_name, rm_code, descriptions, number_of_bands) 
        ...
        if ($stmt_insert->execute()) {
            $message = "Loan Inward record created successfully!";
            $messageType = "success";

             
            header("Location: loan_inward_display.php");
            exit();
        } else {
            $message = "Error inserting loan inward record.";
            $messageType = "error";
        }
    }
...
<head>
    ...
    <title>Loan Inward Management</title>
...
<body>
    <div class="container">
        <div class="form-section">
            <h2>Loan Inward</h2>
            <p>Create and manage your loan inward records with ease. Fill out the form to submit a new loan inward entry.</p>
        ...
        <div class="input-section">
            ...
            <form method="POST" action="" id="loanInwardForm">
                ...
                <div class="form-group">
                    ...
                    <textarea id="descriptions" name="descriptions" rows="4" required placeholder="Enter loan inward details"></textarea>
                </div>
    ...
    <script>
        ...
        // Form Validation
        document.getElementById('loanInwardForm').addEventListener('submit', function(e) {
