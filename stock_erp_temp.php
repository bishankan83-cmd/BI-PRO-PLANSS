    ...
    if (!isset($_FILES["excelFile"]) || $_FILES["excelFile"]["error"] != 0) {
        ...
        if (!in_array($fileExtension, $allowedExtensions)) {
            ...
            try {
                ...
                $stmt = $conn->prepare("INSERT INTO stock_erp_tem2 (serial_number, prev_serial, date, tyre_code, description, qty) VALUES (?, ?, ?, ?, ?, ?)");
...
// Get total count of stock_erp_tem2
$countTempQuery = "SELECT COUNT(*) as total FROM stock_erp_tem2";
...
// Get last 10 records from stock_erp_tem2
$lastTempRecordsQuery = "SELECT * FROM stock_erp_tem2 ORDER BY id DESC LIMIT 10";
