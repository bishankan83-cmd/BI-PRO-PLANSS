...
$query = "SELECT * FROM non_moveing_tire WHERE 1=1";
$params = [];
...
$years_query = $conn->query("SELECT DISTINCT year FROM non_moveing_tire ORDER BY year");
$brands_query = $conn->query("SELECT DISTINCT brand FROM non_moveing_tire ORDER BY brand");
$months_query = $conn->query("SELECT DISTINCT month FROM non_moveing_tire ORDER BY month");
?>
...
<head>
    <meta charset="UTF-8">
    <title>Non-Moving Tire Tracking</title>
    <style>
        body {
...
<body>
    <h1>Non-Moving Tire Tracking</h1>
    ...
    <div class="filter-container">
        <form method="GET">
            ...
            <button type="button" onclick="window.location.href='non_moving_tire_tracking.php'">Reset</button>
        </form>
    </div>
