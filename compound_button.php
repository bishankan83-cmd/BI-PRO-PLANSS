...
<body>
  <div class="container">
    <form method="post" action="">
      <input type="submit" name="button1" value="Tire Wise" class="gradient-button">
    </form>
    <form method="post" action="">
      <input type="submit" name="button2" value="Day Wise" class="gradient-button">
    </form>

    <form method="post" action="">
      <input type="submit" name="button3" value="Month Wise" class="gradient-button">
    </form>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['button1'])) {
        ...
        header("Location: check_compound.php");
        exit();
    } elseif (isset($_POST['button2'])) {
        // Redirect to the desired page when Button 2 is clicked
        header("Location: check_compound2.php");
        exit();
    }

    elseif (isset($_POST['button3'])) {
        // Redirect to the desired page when Button 2 is clicked
        header("Location: check_compound34.php");
        exit();
    }
}
