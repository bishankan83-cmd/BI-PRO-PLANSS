...
<body>
  <div class="container">
    <form method="post" action="">
      <input type="submit" name="button1" value="Add New Mold" class="gradient-button">
    </form>
    <form method="post" action="">
      <input type="submit" name="button2" value="Add New Tire Mold" class="gradient-button">
    </form>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['button1'])) {
        ...
        header("Location: enter_mold.php");
        exit();
    } elseif (isset($_POST['button2'])) {
        // Redirect to the desired page when Button 2 is clicked
        header("Location: enter_tire_mold.php");
        exit();
    }
}
