    ...
    try {
        ...
        if ($row = $result->fetch_assoc()) {
            ...
            if ($delete_record) {
                ...
                $delete_sql = "DELETE FROM loan_inward_details WHERE loan_number = ?";
                ...
                $update_sql = "UPDATE loan_inward_details 
            ...
            header("Location: view_inserted_data2.php?loan_number=" . urlencode($selected_po_number));
            exit();
