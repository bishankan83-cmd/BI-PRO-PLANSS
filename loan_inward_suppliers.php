...
<body>
        ...
        <div class="row">
            <div class="col-12">
                <div class="table-container">
                    ...
                    $sql = "SELECT * FROM loan_inward_suppliers";
                    $result = $conn->query($sql);
                    ?>

                    <table id="loanInwardSuppliersTable" class="table table-striped table-hover">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Supplier Code</th>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="9" class="text-center">
                                        <div class="no-data">
                                            <h2>No Loan Inward Suppliers Found</h2>
                                            <p>There are currently no loan inward suppliers in the system.</p>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
    ...
    $(document).ready(function() {
        ...
        $('#loanInwardSuppliersTable').DataTable({
            responsive: true,
            pageLength: 10,
