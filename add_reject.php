...
<option value="DOUBLE MOULDING">DOUBLE MOULDING</option>
<option value="WRONG MOLD">WRONG MOLD</option>
<option value="early unloading">early unloading</option>
...
function addRow() {
    ...
    const rejectInput = document.createElement("input");
            ...
            rejectInput.value = "REJECT"; // Set default value for the Reject column
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            if (existingRejectInput) {
                existingRejectInput.value = "REJECT";
            }
        });
    </script>
</body>
