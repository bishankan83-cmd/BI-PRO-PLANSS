...
<body>
  <div class="container">
    ...
    <form method="post" action="">
      <input type="submit" name="button2" value="Daily Pending Reject" class="gradient-button">
    </form>


    <form method="post" action="">
      <input type="submit" name="button3" value="Reject Analysis Hub" class="gradient-button">
    </form>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['button1'])) {
        ...
        header("Location: pending_reject.php");
        exit();
    }
