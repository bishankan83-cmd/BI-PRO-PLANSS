...
$sql = "SELECT * FROM loan_outward_details2 WHERE loan_number = ? ORDER BY created_at DESC LIMIT 1";
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 details-container">
                ...
                <div class="text-center mt-4">
                    <a href="l_order_outward.php" class="btn btn-custom">Back to Loan Inward Management</a>
                </div>
            </div>
        </div>
    </div>
