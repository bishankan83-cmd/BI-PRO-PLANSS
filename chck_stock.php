...
{
    global $con;
    $query = "SELECT SUM(cstock) AS total_stockk FROM stock";
    $result = mysqli_query($con, $query);
...
<div class="container">
    ...
    <div class="totals-container">
        <p id="combinedTotals">
            Total Stock On Hand: <?= calculateTotalStockOnHand(); ?> |
            Total Requirement: <?= calculateTotalRequirement(); ?> |
            Total Free Stock: <?= calculateTotalFreeStock(); ?>
        </p>
    </div>
</div>
...
// Calculate the difference between totalCalculatedColumn2 and totalCalculatedColumn1
$difference = $totalCalculatedColumn1 - $totalCalculatedColumn2;


echo '<div style="text-align: center;">';
echo "<p>FG Stock Green Tire Weight: $totalCalculatedColumn1 | Total Requirement Weight: $difference | Total Free Stock Weight: $totalCalculatedColumn2 |  </p>";
echo '</div>';
