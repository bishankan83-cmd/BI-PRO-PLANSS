...
<div class="col-sm-4 col-xxxl-3">
    ...
    <div class="col-sm-4 col-xxxl-3">
                <a class="element-box el-tablo" href="pro_serial_pro.php">
                    <div id="myDIV">Serial Number Production</div>
    ...
    <div class="col-sm-4 col-xxxl-3">
                <a class="element-box el-tablo" href="reverse_serial_pro.php">
                    <div id="myDIV">Reverse Serial Number Production</div>
