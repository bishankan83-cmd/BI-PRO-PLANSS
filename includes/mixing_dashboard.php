    ...
    <div class="element-content">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-xxxl-3">
                ...
                <a class="element-box el-tablo" href="mixingdashboard211.php">
                    <div id="myDIV">Compound Issue Details</div>
                </a>


                <a class="element-box el-tablo" href="mixingdashboard21.php">
                    <div id="myDIV">Compound Input Pending</div>
                </a>
