...
<div class="container">
    ...
    <div class="search-form">
        ...
        <input type="text" id="serialNumberFilter" placeholder="Search by Job Number...">
    ...
    // SQL query to select all data from the bcompound_copy2 table and order by issue_date
$sql = "SELECT * FROM bcompound_copy2 ORDER BY created_at DESC";
