...
// SQL query to copy data from tobeplan_plan to tobeplan1
$copyDataQuery = "INSERT INTO tobeplan12345 SELECT * FROM tobeplan_plan";
if ($conn->query($copyDataQuery) === TRUE) {
    //echo "Data deleted from tobeplan_plan successfully.<br>";
} else {
    //echo "Error deleting data from tobeplan_plan: " . $conn->error . "<br>";
}


// SQL query to delete data from tobeplan_plan
...
if ($count > 0) {
    // Copy data from tobeplan1234 to tobeplan_plan
    $copyDataToTobeplanSQL = "INSERT INTO tobeplan_plan (id, icode, tobe, erp, stockonhand)
    SELECT t.id, t.icode, t.tobe, t.erp, t.stockonhand
    FROM tobeplan1234 t";

    if ($conn->query($copyDataToTobeplanSQL) === TRUE) {
//echo "Data copied from tobeplan1234 to tobeplan_plan successfully.<br>";
    } else {
     //   echo "Error copying data from tobeplan1234 to tobeplan_plan: " . $conn->error . "<br>";
    }
