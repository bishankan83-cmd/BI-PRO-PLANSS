...
foreach ($pricePendingOrders as &$po) {
    ...
    // Adjust table/column names to match your schema for order line items
    ...
    $po['icodes'] = $icodes;
    // Build the deep-link URL to customer_items.php
    $params = ['cus_id' => $po['cus_id'], 'order_id' => $po['order_id']];
    $po['price_link'] = 'customer_items.php?' . http_build_query($params);
}
unset($po);
?>
<!DOCTYPE html>
    ...
    <style>
        ...
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
        ...
        .brand-icon {
            ...
            font-size:1.05rem; color:#fff; box-shadow:0 4px 12px var(--orange-glow);
        }
...
<!-- TOPBAR -->
<header class="topbar">
    <a href="export.php" class="brand">
        <div class="brand-icon"><i class="fas fa-tachometer-alt"></i></div>
        <span class="brand-name">Customer<em>Hub</em></span>
    </a>

    <nav class="topnav">
        <a href="export.php"         class="nav-link active"><i class="fas fa-home"></i> Dashboard</a>
                        ...
                        <div class="np-item">
                            ...
                            <div class="np-body">
                                ...
                                <div class="np-actions">
                                    <!-- Deep link: opens customer_items.php with customer + order pre-selected -->
...
<main class="page">
    ...
    <div class="action-grid">
        ...
        <a href="customer_items.php" class="action-card">
        ...
        <div class="pending-card" id="pcard_<?php echo htmlspecialchars($po['order_id']); ?>">
            ...
            <div class="pending-card-body">
                ...
                <div class="pcb-actions">
                    <!--
                        PRIMARY action: opens customer_items.php with:
                         - cus_id  → auto-selects the customer
                         - order_id → customer_items.php reads item codes from this order and pre-filters the price table
                    -->
                    ...
                    <a href="orders-list.php?order_id=<?php echo urlencode($po['order_id']); ?>" class="pcb-btn pcb-btn-secondary">
