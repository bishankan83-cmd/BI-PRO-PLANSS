...
if ($acm) { $cusPiConfirmOrders = mysqli_fetch_assoc(mysqli_query($con, "SELECT COUNT(*) as count FROM tire_orders WHERE status='confirm_marketing' AND customer_id IN ($userIdsStr)"))['count']; }
else { $stmt = mysqli_prepare($con, "SELECT COUNT(*) as count FROM tire_orders WHERE status='confirm_marketing'"); mysqli_stmt_execute($stmt); $cusPiConfirmOrders = mysqli_fetch_assoc(mysqli_stmt_get_result($stmt))['count']; mysqli_stmt_close($stmt); }
...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .alert-teal .notification-count-badge{color:#1abc9c}.alert-purple .notification-count-badge{color:#9b59b6}
...
if ($cusPiConfirmOrders > 0)
    $notifications[] = ['id'=>'topAlertPurple','class'=>'alert-purple','icon'=>'fas fa-file-invoice',
        ...
        'count'=>$cusPiConfirmOrders,'href'=>'tire-orders-marketing-share-planning_ex.php?status=confirm_marketing',
    ...
    <main class="main-content">
        ...
        <div class="stats-container animate-in">
            <div class="stat-card info">
                ...
                <a href="tire-orders_mar_ex.php" class="stat-link">View Orders <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="stat-card warning">
                ...
                <a href="tire-orders_mar_ex.php?status=pending" class="stat-link">Process Orders <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="stat-card success">
                ...
                <a href="tire-orders_mar_ex.php?status=confirmed" class="stat-link">View Confirmed <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="stat-card purple">
                ...
                <a href="tire-orders_mar_ex.php?status=confirm_marketing" class="stat-link">View PI Orders <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="stat-card info">
        ...
        <div class="content-grid" style="margin-top:1.5rem">
            <div class="card">
                <div class="card-header orders-hdr">
                    ...
                    <a href="tire-orders_mar_ex.php" class="btn btn-secondary" style="padding:.5rem 1rem;font-size:.8rem">View All</a>
                </div>
                <div class="card-body">
                            ...
                            <?php while ($order = mysqli_fetch_assoc($recentOrders)): ?>
                                <a href="order-details.php?oid=<?php echo $order['order_id']; ?>" class="order-item">
                                    ...
                                    <div class="status-badge <?php
                                        ...
                                        elseif ($order['status']==='confirm_marketing')        echo 'status-cus-pi-confirm';
                                    ...
                                    ?>">
                                        ...
                                        elseif ($order['status']==='confirm_marketing')        echo 'PI Confirmed';
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="quick-actions">
                        <a href="tire-orders_mar_ex.php?status=pending" class="action-card orders-action">
                        ...
                        <a href="tire-orders-marketing-share-planning_ex.php?status=confirm_marketing" class="action-card orders-action">
                        ...
                        <a href="tire-orders_mar_ex.php" class="action-card orders-action">
