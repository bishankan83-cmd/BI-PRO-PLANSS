...
<head>
    ...
    <title>CMS | In process Tire Complaints</title>
...
<body>
    <div class="container">
        <div class="page-header">
            <div>
                <h1 class="page-title">In process Tire Complaints</h1>
                <p class="page-subtitle">View and manage tire complaints with In process status.</p>
            </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <?php 
                            $query = mysqli_query($con, "SELECT * FROM tbl_tire_complaints WHERE status = 'In process' ORDER BY created_at DESC");
                            $cnt = 1;
                            ...
                            ?>
                                <tr>
                                    <td colspan="7" class="empty-state">
                                        ...
                                        <p>All complaints have been processed or none exist with In process status.</p>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
                ...
                <?php if (mysqli_num_rows($query) > 0): ?>
                    <div class="mt-3">
                        <small class="text-muted">
                            Total In process Complaints: <strong><?php echo mysqli_num_rows($query); ?></strong>
                        </small>
                    </div>
                <?php endif; ?>
            </div>
