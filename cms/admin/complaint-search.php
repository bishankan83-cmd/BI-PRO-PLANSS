    ...
    <div class="container">
        ...
        <nav class="sidebar" id="sidebar">
            ...
            <div class="nav-section">
                ...
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="complaint-search.php" class="active">
        ...
        <main class="main-content">
            <div class="page-header">
                <div>
                    <h1 class="page-title">Search Complaints</h1>
                    <p class="page-subtitle">Search complaints by complaint number, complainant name, or contact number</p>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="dashboard.php"><i class="fas fa-home"></i> Dashboard</a></li>
                    <li class="breadcrumb-item active">Search Complaints</li>
                </ul>
            </div>
            ...
            <div class="card animate-in" style="margin-bottom: 2rem;">
                <div class="card-header">
                    <h2 class="card-title">Search Complaints</h2>
                </div>
                <div class="card-body">
                    <form method="post">
                        <div class="form-group">
                            ...
                            <input type="search" name="search" id="search" class="form-control" 
                                   placeholder="Search by Complaint Number, Complainant Name, or Contact Number" required>
                        </div>
            ...
            ?>
                <div class="card animate-in">
                    <div class="card-header">
                        <h2 class="card-title">Search Results for: <?php echo htmlentities($search); ?></h2>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($con, "SELECT tblcomplaints.*, users.fullName as name 
                                                                ...
                                                                WHERE tblcomplaints.complaintNumber LIKE '%$search%' 
                                                                OR users.fullName LIKE '%$search%' 
                                                                OR users.contactNo LIKE '%$search%'");
                                    $cnt = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:void(0);" 
                                                       onClick="popUpWindow('complaint-details.php?cid=<?php echo htmlentities($row['complaintNumber']); ?>', 200, 200, 600, 600);" 
