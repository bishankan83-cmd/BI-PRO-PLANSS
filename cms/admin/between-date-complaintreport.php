...
<head>
    ...
    <title>CMS | Between Dates Tire Complaints Report</title>
    ...
    <div class="container">
        ...
        <nav class="sidebar" id="sidebar">
            ...
            <div class="nav-section">
                ...
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="between-date-complaintreport.php" class="active">
        ...
        <main class="main-content">
            <div class="page-header">
                <div>
                    <h1 class="page-title">Between Dates Tire Complaints Report</h1>
                    <p class="page-subtitle">Generate a report of tire complaints between selected dates</p>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="dashboard.php"><i class="fas fa-home"></i> Dashboard</a></li>
                    <li class="breadcrumb-item active">Between Dates Tire Complaints Report</li>
                </ul>
            </div>
            ...
            <div class="card animate-in" style="margin-bottom: 2rem;">
                <div class="card-header">
                    <h2 class="card-title">Filter Complaints by Date</h2>
                </div>
                <div class="card-body">
                    <form method="post">
            ...
            ?>
                <div class="card animate-in">
                    <div class="card-header">
                        <h2 class="card-title">Tire Complaints Report: <?php echo htmlentities($fdate); ?> to <?php echo htmlentities($tdate); ?></h2>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($con, "SELECT tbl_tire_complaints.*, users.fullName AS name 
                                                                ...
                                                                WHERE tbl_tire_complaints.created_at BETWEEN '$fdate' AND '$tdate'");
                                    $cnt = 1;
