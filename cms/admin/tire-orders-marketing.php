...
if (strlen($_SESSION['aid']) == 0) {
    ...
    // === ONLY cus_pi_confirm STATUS ===
    $statusFilter = " AND o.status = 'cus_pi_confirm'";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="status-badge">
                                            Customer Successfully Confirmed PI
                                        </span>
                                    </td>
                                    <td><small><?php echo nl2br(htmlentities($row['order_notes'] ?: '-')); ?></small></td>
                                    <td>
                                        <a href="view-tire-order-mar.php?id=<?php echo $row['order_id']; ?>" class="btn btn-primary">
