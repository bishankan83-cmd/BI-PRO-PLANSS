...
if (strlen($_SESSION['aid']) == 0) {
    ...
    // === ONLY confirm_marketing STATUS ==f=
    $statusFilter = " AND o.status = 'confirm_marketing'";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="status-badge">
                                            Account manager Successfully Confirmed PI
                                        </span>
                                    </td>
                                    <td><small><?php echo nl2br(htmlentities($row['order_notes'] ?: '-')); ?></small></td>
                                    <td>
                                        <a href="view-tire-orders-pi-mar_ex.php?id=<?php echo $row['order_id']; ?>" class="btn btn-primary">
                                ...
                                <tr>
                                    <td colspan="9">
                                        <div class="no-data">
                                            ...
                                            <p>There are no orders with customer confirmed PI status.</p>
                                        </div>
                                    </td>
                                </tr>
                            <?php
