        ...
        <main class="main-content">
            <div class="page-header">
                <div>
                    ...
                    <p class="page-subtitle">Search for users by name, email, or contact number.</p>
                </div>
                        ...
                        <div class="row align-items-end">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="search" name="search" id="search" placeholder="Search by Mobile Number, Name, or Email" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
            ...
            ?>
                <div class="card animate-in">
                    ...
                    <div class="card-body">
                        <div class="search-title">Search Results for: <strong><?php echo htmlentities($search); ?></strong></div>
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($con, "SELECT * FROM users WHERE contactNo LIKE '%$search%' OR fullName LIKE '%$search%' OR userEmail LIKE '%$search%'");
                                    $cnt = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="javascript:void(0);" 
                                                       onclick="popUpWindow('user-profile.php?uid=<?php echo htmlentities($row['id']); ?>', 100, 100, 600, 600);" 
                                                       class="btn btn-primary btn-sm" title="View Details">
                                                        <i class="fas fa-eye"></i> View
                                                    </a>
                                                    <a href="user-search.php?uid=<?php echo htmlentities($row['id']); ?>&action=del" 
                        ...
                        <?php if (mysqli_num_rows($query) > 0): ?>
                            <div class="mt-3">
                                <small class="text-muted">
                                    Total Users Found: <strong><?php echo mysqli_num_rows($query); ?></strong>
                                </small>
                            </div>
                        <?php endif; ?>
                    </div>
