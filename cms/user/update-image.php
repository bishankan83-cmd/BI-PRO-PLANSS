...
<head>
    ...
    <title>Customer Service Portal - Update Profile Photo</title>
...
<body>
    ...
    <div class="container">
        ...
        <main class="main-content">
            <div class="page-header">
                <div>
                    <h1 class="page-title">Update Profile Photo</h1>
                    <p class="page-subtitle">Upload a new profile photo</p>
                </div>
            ...
            <div class="card animate-in">
                ...
                <div class="card-body">
                    <form method="post" name="update_image" enctype="multipart/form-data">
                        <div class="form-section">
                            <h6 class="section-title">Profile Photo</h6>
                            <div class="row">
                                <?php
                                $id = intval($_SESSION["id"]);
                                $query = mysqli_query($con, "SELECT userImage FROM users WHERE id='$id'");
                                ...
                                ?>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <?php if ($userphoto == ""): ?>
                                                    <img src="userimages/noimage.png" class="user-photo" alt="No Photo">
                                                <?php else: ?>
                                                    <img src="userimages/<?php echo htmlentities($userphoto); ?>" class="user-photo" alt="User Photo">
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="image">Upload New Photo <span class="required">*</span></label>
                                            <input type="file" name="image" id="image" class="form-control" required accept=".jpg,.jpeg,.png,.gif">
    ...
    <script>
        ...
        console.log('Update Profile Photo Page loaded successfully!');
    </script>
</body>
</html>