...
if(strlen($_SESSION['login']) == 0) { 
    ...
    // Code for permanently deleting a category
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            &nbsp;<a href="manage-categories.php?rid=<?php echo htmlentities($row['id']); ?>&&action=parmdel" title="Delete forever"><i class="fa fa-trash-o" style="color: #f05050"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php 
                                                $cnt++;
