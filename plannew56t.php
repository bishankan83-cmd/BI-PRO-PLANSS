...
$deleteQuery = "DELETE FROM plannew3";
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $sql_old_process = "SELECT start_date FROM old_process WHERE icode = '$icode' AND erp = '$erp_number'";
        ...
        $sql = "INSERT INTO plannew3 (id, icode, mold_id, cavity_id, start_date, end_date, erp, tires_per_mold)
...
//header("Location: check_date341.php");
//exit();
