...
if (isset($_GET['search'])) {
    $search = $_GET['search'];
    $result = $conn->query("SELECT id, erp, com_date FROM complete_date WHERE id LIKE '%$search%' OR com_date LIKE '%$search%' OR erp LIKE '%$search%'");
} else {
    $result = $conn->query("SELECT id, erp, com_date FROM complete_date");
}
?>
...
<body>
    ...
    <?php while ($row = $result->fetch_assoc()): ?>
        <tr>
            ...
            <td><?= htmlspecialchars($row['com_date']) ?></td>
