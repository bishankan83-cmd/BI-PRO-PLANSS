        ...
        $(document).ready(function() {
            ...
            function generateSinglePdf(qrData, callback, doc) {
                try {
                    ...
                    // QR code includes InventoryID, LotSerialNbr (serial number), and TB (description)
                    ...
                    setTimeout(() => {
                        ...
                        if (qrCanvas) {
                            ...
                            if (qrData) {
                                // Display Serial Number - BOLD and LARGE
                                doc.setFont('helvetica', 'bold');
                                ...
                                // *** CHANGED: Replaced 'LotSerialNbr:' label with 'MADE IN SRI LANKA' on the sticker ***
                                const rightFields = [
