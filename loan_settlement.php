...
if (isset($_POST['insert_data']) && $selected_po_number) {
    ...
    try {
        ...
        if ($row = $result->fetch_assoc()) {
            ...
            if ($delete_record) {
                // Delete the record from loan_inward_details
                $delete_sql = "DELETE FROM loan_inward_details2 WHERE loan_number = ?";
                ...
                if (!$delete_stmt->execute()) {
                    throw new Exception("Error deleting from loan_inward_details: " . $delete_stmt->error);
                }
            } else {
                // Update the record with the new number of bands
                $update_sql = "UPDATE loan_inward_details2 
                ...
                if (!$update_stmt->execute()) {
                    throw new Exception("Error updating loan_inward_details: " . $update_stmt->error);
                }
            }
            ...
            header("Location: view_inserted_data4.php?loan_number=" . urlencode($selected_po_number));
            exit();
...
<head>
    ...
    <title>Loan Inward Management System</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 container-custom">
                <div class="page-header">
                    <h2 class="mb-0">Loan Inward Management</h2>
                </div>
